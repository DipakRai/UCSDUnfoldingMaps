...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		map1 = new UnfoldingMap(this, 50, 50, 350, 500, provider);//x start,y start, width, height
		...
		map2.zoomAndPanTo(zoomLevel, new Location(22.7f, 88.3f));
